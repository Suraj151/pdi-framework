...
is stored in program memory (PROG_RODT_ATTR) to optimize memory usage on embedded
systems.
 ...
 */
static const char WEB_SERVER_DEVICE_REGISTER_CONFIG_PAGE_TOP[] PROG_RODT_ATTR = "\
